...
public record RepositoryBookOps(Repository repository) {
	public void create(@NotNull Book book, @NotNull Book.Data data) throws Repository.TransactionException {
	...
	public void update(@NotNull Book book, @NotNull Function<Book.@NotNull Data, Book.@NotNull Data> callback) throws Repository.TransactionException {
	...
	public void delete(@NotNull Book book) throws Repository.TransactionException {
